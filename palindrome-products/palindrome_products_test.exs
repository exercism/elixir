...
defmodule PalindromeProductsTest do
  ...
  test "largest palindrome from single digit factors" do
    ...
    assert [[1, 9], [3, 3]] == Enum.at(palindromes, 9)
  end
