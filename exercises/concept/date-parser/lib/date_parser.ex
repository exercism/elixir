defmodule DateParser do
  ...
  def match_numeric_date() do
    ~r// # Please implement the match_numeric_date/0 function
  end

  def match_month_name_date() do
    ~r// # Please implement the match_month_name_day/0 function
  end

  def match_day_month_name_date() do
    ~r// # Please implement the match_day_month_name_date/0 function
  end
end
