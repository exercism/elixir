...
The freelancer is offering to apply a discount if the project manager chooses to let the freelancer bill at the end of each month (regardless of how many days have been worked), which can come in handy if there is a certain budget the project manager has to work with.
