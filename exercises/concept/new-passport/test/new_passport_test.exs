defmodule NewPassportTest do
  ...
  describe "getting into the building" do
    ...
    test "building is closed in the morning" do
      assert NewPassport.get_new_passport(~N[2021-10-11 10:30:00], ~N[1984-09-14 12:00:00], :blue) ==
               {:error, "city office is closed"}
    end

    @tag task_id: 1
    test "building is closed early on Friday afternoon" do
      assert NewPassport.get_new_passport(~N[2021-10-08 15:00:00], ~N[1984-09-14 12:00:00], :blue) ==
               {:error, "city office is closed"}
    end
  ...
  describe "find the right counter" do
    ...
    test "information staff on coffee break" do
      assert NewPassport.get_new_passport(~N[2021-10-11 14:10:00], ~N[1984-09-14 12:00:00], :blue) ==
    ...
    test "information staff on coffee break on Friday 15 minutes before closing time" do
      assert NewPassport.get_new_passport(~N[2021-10-08 14:15:00], ~N[1984-09-14 12:00:00], :blue) ==
               {:retry, ~N[2021-10-08 14:30:00]}
    end

    @tag task_id: 2
    test "retry after previous attempt, hit closing time" do
      assert NewPassport.get_new_passport(~N[2021-10-08 14:30:00], ~N[1984-09-14 12:00:00], :blue) ==
               {:error, "city office is closed"}
    end
  end
  ...
  describe "get the passport form stamped" do
    ...
    test "wrong form color" do
      assert NewPassport.get_new_passport(~N[2021-10-11 14:25:00], ~N[1984-09-14 12:00:00], :red) ==
               {:error, "wrong form color"}
    end
  ...
  describe "receive the new passport number" do
    ...
    test "get the right timestamp after waiting for coffee break" do
      assert NewPassport.get_new_passport(~N[2021-10-11 14:15:00], ~N[1984-09-14 12:00:00], :blue) ==
    ...
    test "get the right timestamp after waiting twice for coffee break" do
      assert NewPassport.get_new_passport(~N[2021-10-11 14:00:00], ~N[1984-09-14 12:00:00], :blue) ==
    ...
    test "get the right passport number" do
      assert NewPassport.get_new_passport(~N[2021-10-11 15:00:00], ~N[1984-09-14 12:00:00], :blue) ==
    ...
    test "get a passport number after waiting for a coffee break" do
      ...
      assert NewPassport.get_new_passport(~N[2021-10-11 14:30:00], ~N[1964-09-14 12:00:00], :red) ==
    ...
    test "get a passport number after two coffee breaks" do
      ...
      assert NewPassport.get_new_passport(~N[2021-10-12 14:30:00], ~N[2000-04-14 12:00:00], :red) ==
