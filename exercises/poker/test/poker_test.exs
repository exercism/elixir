defmodule PokerTest do
  ...
  defp assert_is_a_set_containing(lists, to_contain) do
    sets = Enum.map(lists, &Enum.into(&1, MapSet.new()))

    same_contents = Enum.map(to_contain, &Enum.into(&1, MapSet.new()))

    are_they_eq =
      Enum.zip(sets, same_contents)
      |> Enum.all?(fn {l1, l2} -> MapSet.equal?(l1, l2) end)

    assert are_they_eq,
           "Expected a set with: #{inspect(to_contain)} got #{
             inspect(Enum.map(sets, &MapSet.to_list(&1)))
           }"
  end
  ...
  test "single hand always wins" do
    ...
    assert Poker.best_hand([high_of_jack]) |> assert_is_a_set_containing([high_of_jack])
  end
  ...
  test "highest card out of all hands wins" do
    ...
    assert Poker.best_hand([high_of_8, high_of_10, high_of_jack])
           |> assert_is_a_set_containing([high_of_jack])
  end
  ...
  test "a tie has multiple winners" do
    ...
    assert Poker.best_hand(hands)
           |> assert_is_a_set_containing([high_of_jack, another_high_of_jack])
  end
  ...
  test "multiple hands with the same high cards, tie compares next highest ranked, down to last card" do
    ...
    assert Poker.best_hand([high_of_8_low_of_3, high_of_8_low_of_2])
           |> assert_is_a_set_containing([high_of_8_low_of_3])
  end
  ...
  test "one pair beats high card" do
    ...
    assert Poker.best_hand([high_of_king, pair_of_4]) |> assert_is_a_set_containing([pair_of_4])
  end
  ...
  test "highest pair wins" do
    ...
    assert Poker.best_hand([pair_of_2, pair_of_4]) |> assert_is_a_set_containing([pair_of_4])
  end
  ...
  test "two pairs beats one pair" do
    ...
    assert Poker.best_hand([pair_of_8, fives_and_fours])
           |> assert_is_a_set_containing([fives_and_fours])
  end
  ...
  test "both hands have two pairs, highest ranked pair wins" do
    ...
    assert Poker.best_hand([eights_and_twos, fives_and_fours])
           |> assert_is_a_set_containing([eights_and_twos])
  end
  ...
  test "both hands have two pairs, with the same highest ranked pair, tie goes to low pair" do
    ...
    assert Poker.best_hand([queens_and_twos, queens_and_jacks])
           |> assert_is_a_set_containing([queens_and_jacks])
  end
  ...
  test "both hands have two identically ranked pairs, tie goes to remaining card (kicker)" do
    ...
    assert Poker.best_hand([queens_jacks_and_8, queens_jacks_and_2])
           |> assert_is_a_set_containing([queens_jacks_and_8])
  end
  ...
  test "three of a kind beats two pair" do
    ...
    assert Poker.best_hand([eights_and_twos, three_fours])
           |> assert_is_a_set_containing([three_fours])
  end
  ...
  test "both hands have three of a kind, tie goes to highest ranked triplet" do
    ...
    assert Poker.best_hand([three_twos, three_aces]) |> assert_is_a_set_containing([three_aces])
  end
  ...
  test "with multiple decks, two players can have same three of a kind, ties go to highest remaining cards" do
    ...
    assert Poker.best_hand([three_aces_7_high, three_aces_8_high])
           |> assert_is_a_set_containing([three_aces_8_high])
  ...
  test "a straight beats three of a kind" do
    ...
    assert Poker.best_hand([three_fours, straight]) |> assert_is_a_set_containing([straight])
  end
  ...
  test "aces can be end a straight (10 J Q K A)" do
    ...
    assert Poker.best_hand([three_fours, straight_to_ace])
           |> assert_is_a_set_containing([straight_to_ace])
  end
  ...
  test "aces can be start a straight (A 2 3 4 5)" do
    ...
    assert Poker.best_hand([three_fours, straight_to_5])
           |> assert_is_a_set_containing([straight_to_5])
  end
  ...
  test "both hands with a straight, tie goes to highest ranked card" do
    ...
    assert Poker.best_hand([straight_to_8, straight_to_9])
           |> assert_is_a_set_containing([straight_to_9])
  end
  ...
  test "even though an ace is usually high, a 5-high straight is the lowest-scoring straight" do
    ...
    assert Poker.best_hand([straight_to_6, straight_to_5])
           |> assert_is_a_set_containing([straight_to_6])
  end
  ...
  test "flush beats a straight" do
    ...
    assert Poker.best_hand([straight_to_8, flush_to_7])
           |> assert_is_a_set_containing([flush_to_7])
  end
  ...
  test "both hands have a flush, tie goes to high card, down to the last one if necessary" do
    ...
    flush_to_7 = ~w(2S 4S 5S 6S 7S)
    assert Poker.best_hand([flush_to_9, flush_to_7]) |> assert_is_a_set_containing([flush_to_9])

    flush_to_9_with_4_matches = ~w(3S 6S 7S 8S 9S)

    assert Poker.best_hand([flush_to_9, flush_to_9_with_4_matches])
           |> assert_is_a_set_containing([flush_to_9])
  end
  ...
  test "full house beats a flush" do
    ...
    assert Poker.best_hand([flush_to_8, full]) |> assert_is_a_set_containing([full])
  end
  ...
  test "both hands have a full house, tie goes to highest-ranked triplet" do
    ...
    assert Poker.best_hand([full_of_4_by_9, full_of_5_by_8])
           |> assert_is_a_set_containing([full_of_5_by_8])
  end
  ...
  test "with multiple decks, both hands have a full house with the same triplet, tie goes to the pair" do
    ...
    assert Poker.best_hand([full_of_5_by_9, full_of_5_by_8])
           |> assert_is_a_set_containing([full_of_5_by_9])
  end
  ...
  test "four of a kind beats a full house" do
    ...
    assert Poker.best_hand([four_3s, full]) |> assert_is_a_set_containing([four_3s])
  end
  ...
  test "both hands have four of a kind, tie goes to high quad" do
    ...
    assert Poker.best_hand([four_2s, four_5s]) |> assert_is_a_set_containing([four_5s])
  end
  ...
  test "with multiple decks, both hands with identical four of a kind, tie determined by kicker" do
    ...
    assert Poker.best_hand([four_3s_and_2, four_3s_and_4])
           |> assert_is_a_set_containing([four_3s_and_4])
  end
  ...
  test "straight flush beats four of a kind" do
    ...
    assert Poker.best_hand([four_5s, straight_flush_to_10])
           |> assert_is_a_set_containing([straight_flush_to_10])
  end
  ...
  test "both hands have straight flush, tie goes to highest-ranked card" do
    ...
    assert Poker.best_hand([straight_flush_to_8, straight_flush_to_9])
           |> assert_is_a_set_containing([straight_flush_to_9])
  end
end
