...
defmodule ForthTest do
  ...
  test "division by zero" do
    assert_raise Forth.DivisionByZero, fn -> Forth.new() |> Forth.eval("4 2 2 - /") end
  end
  ...
  test "dup" do
    ...
    assert s == "1 2 2"
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("dup") end
  end
  ...
  test "drop" do
    ...
    assert s == "1"
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("drop") end
  end
  ...
  test "swap" do
    ...
    assert s == "1 3 2"
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("1 swap") end
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("swap") end
  end
  ...
  test "over" do
    ...
    assert s == "1 2 3 2"
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("1 over") end
    assert_raise Forth.StackUnderflow, fn -> Forth.new() |> Forth.eval("over") end
  end
  ...
  test "defining a number" do
    assert_raise Forth.InvalidWord, fn -> Forth.new() |> Forth.eval(": 1 2 ;") end
  end

  @tag :pending
  test "calling a non-existing word" do
    assert_raise Forth.UnknownWord, fn -> Forth.new() |> Forth.eval("1 foo") end
  end
end
